...
const initBuffer = () => {
  const shaderProgram = initShaderProgram(gl, vertexString, fragmentString);

  vertices = new Float32Array([-0.5, 0, 0.5, 0, 0, 0.5]);
  ...
  gl.vertexAttribPointer(a_position, 2, gl.FLOAT, false, 0, 0); //告诉GPU如何解释或者解析这个顶点数据
